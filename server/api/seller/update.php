<?php
	/**
	 * API code to update existing Seller
	*/
	...
	if($requestMethod == 'POST') {
		...
		if(isset($_GET['id'])) {
			...
			if(isset($POST['firstname'])) {
				...
				if($firstname != $empty) {
					$firstnameStatus = Seller::update($id, "firstname", $firstname);
			...
			if(isset($POST['lastname'])) {
				...
				if($lastname != $empty) {
					$lastnameStatus = Seller::update($id, "lastname", $lastname);
			...
			if(isset($POST['phonenum'])) {
				...
				if($phonenum != $empty) {
					$phonenumStatus = Seller::update($id, "phonenum", $phonenum);
			...
			if(isset($POST['password'])) {
				...
				if($password != $empty) {
					$passwordStatus = Seller::update($id, "password", $password);
